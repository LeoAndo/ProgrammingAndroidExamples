...
import jp.ac.jec.cm0199.audioplayer.AudioPlayerWAudioTrack;

public class AudioRecorderWAudioRecord extends AppCompatActivity implements Runnable {
    ...
    private void recordOrStop() {
        if (!recordablestate) {
            try {
                ...
                // <uses-permission android:name="android.permission.RECORD_AUDIO"/>が必要。
