...
import jp.ac.jec.cm0199.audioplayer.AudioPlayer;

public class AudioRecorder extends AppCompatActivity implements Runnable {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.recordstop).setOnClickListener(v -> recordOrStop());
        findViewById(R.id.play).setOnClickListener(v -> playAudio());
        findViewById(R.id.register).setOnClickListener(v -> registerAudioFile());
    }
